...
| <code><a href="#@cloudparing/aws-cdk-lib.Cur2Stack.exportValue">exportValue</a></code> | Create a CloudFormation Export for a value. |
...
##### `terminationProtection`<sup>Optional</sup> <a name="terminationProtection" id="@cloudparing/aws-cdk-lib.Cur2Stack.property.terminationProtection"></a>
...
| <code><a href="#@cloudparing/aws-cdk-lib.CurStack.exportValue">exportValue</a></code> | Create a CloudFormation Export for a value. |
...
##### `terminationProtection`<sup>Optional</sup> <a name="terminationProtection" id="@cloudparing/aws-cdk-lib.CurStack.property.terminationProtection"></a>
